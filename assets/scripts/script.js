...
function soundCorrect() {
    let audio = new Audio('../QuizChallenge/assets/audio/335908__littlerainyseasons__correct.mp3');
    audio.play();
}

function soundIncorrect() {
    let audio = new Audio('../QuizChallenge/assets/audio/196106_aiwha_ding.mp3');
    audio.play();
}